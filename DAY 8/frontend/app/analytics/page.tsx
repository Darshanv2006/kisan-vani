      ...
      <main className="mx-auto max-w-7xl px-6 py-8 relative z-10 space-y-8">
        ...
        <footer className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-900/40 px-5 py-3 text-xs text-slate-400">
          <div className="flex items-center gap-2">
            ...
            <span>
              <strong>Caller Privacy scrubbed & protected:</strong> All user PII, PINs, and transcripts strictly handled per Day 8 requirements.
            </span>
          </div>
          <span className="font-mono text-[10px] text-slate-500">Kisan Vani v1.0 • Day 8 Challenge</span>
        </footer>
      </main>
