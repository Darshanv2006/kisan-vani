...
function AgentStatusHeader({ agentState, isConnected }: { agentState?: string; isConnected: boolean }) {
  let badgeColor = 'bg-emerald-500/15 border-emerald-500/40 text-emerald-600 dark:text-emerald-300 shadow-emerald-500/10';
  let pulseDot = 'bg-emerald-500';
  let stateText = 'Connected & Ready 🟢';
  let speakerText = 'Kisan Vani Voice Agent is active — Speak now!';
